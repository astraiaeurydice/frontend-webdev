          ...
          <div className="bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-lg border border-white/10 rounded-3xl p-8 lg:p-10 shadow-2xl">
            ...
            <div className="space-y-10">
              ...
              <div className="relative flex items-center justify-center">
                ...
                <span className="relative px-4 bg-transparent text-gray-500 text-sm">or continue with</span>
              </div>

              {/* Google Sign-In Button */}
              <button
                onClick={handleGoogleLogin}
                className="group relative w-full p-4 bg-white/5 border border-white/10 text-white font-semibold rounded-xl overflow-hidden transition-all duration-300 hover:scale-105 hover:bg-white/10 hover:border-white/20 hover:shadow-xl hover:shadow-white/5 flex items-center justify-center space-x-3"
              >
                {/* Google Icon */}
